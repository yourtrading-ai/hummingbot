...
class MangoV3PerpetualOrderBookMessage(OrderBookMessage):
    def __new__(cls, message_type: OrderBookMessageType, content: Dict[str, any], timestamp: Optional[float] = None,
        ...
        return super(MangoV3PerpetualOrderBookMessage, cls).__new__(cls, message_type, content,
    ...
    def trading_pair(self) -> str:
        return self.content["marketName"]
